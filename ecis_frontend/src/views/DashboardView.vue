        ...
        <div class="mt-6 grid gap-6 xl:grid-cols-3">
            <section class="card p-5 xl:col-span-2">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="muted mt-1">
                            Clinical data accumulates through normal hospital work.
                        </p>
                    </div>
                </div>

                <div class="mt-6 grid gap-3 md:grid-cols-5">
                    <div v-for="(step, index) in workflow" :key="step" class="rounded-xl border border-slate-200 p-4">
            ...
            <section class="card p-5">
                ...
                <div class="mt-4 space-y-3">
                    <div v-for="emergency in emergencies.slice(
                        0,
                        4,
                    )" :key="emergency.id" class="rounded-xl bg-slate-50 p-3">
...
const workflow = [
    ...
    "OPD / Ward care",
    "Surgery & procedures",
    "Clinical findings saved",
    "ECIS searches existing EHR",
];
</script>